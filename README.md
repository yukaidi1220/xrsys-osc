...
<img src="./osc.ico" alt="eeeosc" width="20%" />
...
鹅鹅鹅OS优化组件（EEEOS-OSC，`osc.exe`）完成系统登录进入桌面后的各种优化操作，包括但不限于注册表优化、电源优化、软件安装等🌟🚀

鹅鹅鹅OS优化组件支持完成系统部署的整个流程对各种组件的调用工作，包括但不限于调用万能驱动安装、用户名创建等

📄[文档](https://sys.xrgzs.top/diy/osc/)

🔗[下载地址](https://url.xrgzs.top/osc)

📍**小提示：** 鹅鹅鹅OS优化组件支持直接使用，这意味着您不需要安装鹅鹅鹅OS，只需运行`osc.exe`即可切换到最新版本的鹅鹅鹅OS

**🚨警告：** 在使用鹅鹅鹅OS优化组件之前，**请务必进行备份浏览器里面的重要数据**，并最好将浏览器卸载。鹅鹅鹅OS优化组件会自动清空所有浏览器的数据
